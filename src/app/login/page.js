        ...
        <div className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-2xl shadow-xl p-6 sm:p-8 animate-fade-in-delay-1">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full px-4 py-3 border border-slate-300 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center space-x-2"
              >
